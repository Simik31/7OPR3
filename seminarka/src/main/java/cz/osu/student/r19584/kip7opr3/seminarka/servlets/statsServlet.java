...
public class statsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println(
            ...
            "        </div>\n" +
            "\n" +
            "        <span class=\"y-p100 t-50 font-size-ui-60 position-fixed\">X wins: <span id=\"counter_x\" class=\"counter\" data-start=\"0\" data-target=\"0\" data-digits=\"0\">0</span></span>\n" +
            "        <span class=\"y-p200 t-50 font-size-ui-60 position-fixed\">Draws: <span id=\"counter_d\" class=\"counter\" data-start=\"0\" data-target=\"0\" data-digits=\"0\">0</span></span>\n" +
            "        <span class=\"y-p300 t-50 font-size-ui-60 position-fixed\">O wins: <span id=\"counter_o\" class=\"counter\" data-start=\"0\" data-target=\"0\" data-digits=\"0\">0</span></span>\n" +
            "    </div>\n" +
            "\n" +
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.getWriter().printf(
            " [{\"px\": %.1f,\"pd\": %.1f,\"po\": %.1f,\"cx\": %d,\"cd\": %d,\"co\": %d}]",
            count_x * 100.0 / count_total,
            count_d * 100.0 / count_total,
            count_o * 100.0 / count_total,
            count_x,
            count_d,
            count_o
        );
